...
def _write_version_module(version: str) -> None:
    """Write _version.py into the package so the frozen app knows its version.

    PyInstaller bundles the source tree; this file is included automatically
    because it lives inside ``open_garden_planner/``.
    The update checker (``services/update_checker.py``) reads it at runtime.
    """
    version_file = ROOT / "src" / "open_garden_planner" / "_version.py"
    version_file.write_text(
        f'"""Auto-generated by build_installer.py — do not edit."""\n'
