...
**Package D (D1) complete** — US-D1.1…D1.6 all shipped. Next: **D2/D3** (write/domain tools, gated on token auth) or **Phase 14 (v2.0)** — 3D Visualization & Sun/Shade. See `docs/roadmap.md`.
