...
- The post-D2.4/D2.5 hardening package (#353/#354/#355) shipped in v1.27.10 via PR #360: same-scene document cleanup and fail-closed deletes, authenticated global MCP `undo`/`redo`, bounded callout offsets, and a repeated-median spatial-index guard. The next D2 slice remains geometry escape hatches (#330), followed by D3 (#319, #331–#333) and Packages F/G.
