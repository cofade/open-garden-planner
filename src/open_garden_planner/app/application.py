...
class GardenPlannerApp(QMainWindow):
    ...
    def _setup_central_widget(self) -> None:
        ...
        # drive the toolbar Undo/Redo actions, wired at 1086-1087). Using a single
        # stack_changed wiring collapses the former three-signal fan-out to one and
        # gives correct undo/redo coverage (#206).
        ...
        # changes; an unchanged selection refreshes values in place (#206).
        ...
        # assignment while the plant stays selected). Its set_selected_items uses
        # an incremental toggle-visibility update, so this is cheap (#206).
        cmd_mgr.stack_changed.connect(
