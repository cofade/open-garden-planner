...
- **FR-SYMBOL-01**: A **Smart Symbols** sidebar panel lists the available parametric symbols (bundled + user). Double-clicking (or Insert) drops a `SmartSymbolItem` with default parameters at the viewport centre on the active layer (undoable).
