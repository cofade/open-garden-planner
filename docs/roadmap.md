...
| 💭 | 3 | *(Candidates, unscoped — full context brief in the issue)* furniture/infrastructure canvas art (15 hand-authored 2026-02 SVGs), texture harmonization (incl. de-grandfathering the `flagstone`/`glass` seams; `hedge.png` is the shipped restyle pilot), status-bar/dashboard-tab + Plants/Garden menu iconography. | [#284](https://github.com/cofade/open-garden-planner/issues/284) | — |
