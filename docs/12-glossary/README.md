...
| **Agent API** | The `agent_api/` subsystem: an opt-in, loopback-only embedded MCP server (epic #237, US-D1.1). Read-only in this phase (tool `get_plan_summary`); built write-ready. See FR-26 |
