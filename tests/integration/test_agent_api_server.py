...
def _providers(scene: Any) -> AgentProviders:
    ...
    return AgentProviders(
        ...
        # issue #365: document lifecycle needs a real app window, which this
        # scene-only harness has no seam for. These tests are read/resource/
        # prompt coverage, so the tools are registered but never invoked.
        new_plan=lambda *_a: {},
        open_plan=lambda *_a: {},
        ...
        rotate_object=lambda *_a, **_k: _unused("rotate_object"),
        set_vertex=lambda *_a, **_k: _unused("set_vertex"),
        add_vertex=lambda *_a, **_k: _unused("add_vertex"),
        delete_vertex=lambda *_a, **_k: _unused("delete_vertex"),
        set_species=lambda *_a, **_k: _unused("set_species"),
        set_parent_bed=lambda *_a, **_k: _unused("set_parent_bed"),
        arrange_object=lambda *_a, **_k: _unused("arrange_object"),
        set_object_layer=lambda *_a, **_k: _unused("set_object_layer"),
        create_layer=lambda *_a, **_k: _unused("create_layer"),
        rename_layer=lambda *_a, **_k: _unused("rename_layer"),
        delete_layer=lambda *_a, **_k: _unused("delete_layer"),
        set_active_layer=lambda *_a, **_k: _unused("set_active_layer"),
